...
\begin{document}
    ...
    Most major components, such as parser and preprocessor, or different TA representations and model checking algorithms, are separated into individual Rust crates (see), and specific features are guarded by feature flags.
