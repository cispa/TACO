...
from the grant agreement, TACO and all of its crates are licensed under the
[Apache-2.0 license](https://www.apache.org/licenses/LICENSE-2.0):

```license
Copyright [2025] [The TACO contributors]
...
The TACO documentation is also licensed under
[CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/).

Exceptions, e.g., files that have been taken from other projects, which do not
fall under the same license (like for example the benchmark files copied /
generated from the
[fault-tolerant-benchmarks repository by Igor Konnov](https://github.com/konnov/fault-tolerant-benchmarks)),
have their respective licenses indicated in the respective `LICENSE` or
`README.md` files.

:::{include} ./about/third-party-licenses.html
